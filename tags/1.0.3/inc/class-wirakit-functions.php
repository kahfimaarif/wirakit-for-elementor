...
if ( ! class_exists( 'Wirakit_Functions' ) ) {
	...
	class Wirakit_Functions {
		...
		public function register_admin_menu() {
			...
			add_menu_page(
				__( 'Wira Kit', 'wira-kit-for-elementor' ),
				__( 'Wira Kit', 'wira-kit-for-elementor' ),
				$capability,
			...
			add_submenu_page(
				'wira-kit-for-elementor',
				__( 'Widgets', 'wira-kit-for-elementor' ),
				__( 'Widgets', 'wira-kit-for-elementor' ),
				$capability,
		...
		public function enqueue_admin_assets( $hook_suffix ) {
			...
			wp_localize_script(
				...
				array(
					...
					'pluginName'    => __( 'Wira Kit for Elementor - Widgets & Template Builder System', 'wira-kit-for-elementor' ),
		...
		public static function get_default_settings() {
			...
			foreach ( self::get_module_definitions() as $module ) {
				if ( 'advanced-template-import' === $module['id'] ) {
