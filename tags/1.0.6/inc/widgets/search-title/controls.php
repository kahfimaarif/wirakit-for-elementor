...
/**
 * Controls For Search Title Custom Widgets
 * 
...
$this->start_controls_section(
    'section_content',
    [
        'label' => __( 'Search Title', 'wira-kit-for-elementor' ),
...
$this->add_control(
    ...
    [
        'label'        => __( 'Enable Search Prefix', 'wira-kit-for-elementor' ),
...
$this->add_control(
    'search_prefix_text',
    [
        'label'     => __( 'Search Prefix Text', 'wira-kit-for-elementor' ),
        'type'      => \Elementor\Controls_Manager::TEXT,
        'default'   => __( 'Search results for: ', 'wira-kit-for-elementor' ),
        'condition' => [
            'enable_search_prefix' => 'yes',
        ],
    ]
);
