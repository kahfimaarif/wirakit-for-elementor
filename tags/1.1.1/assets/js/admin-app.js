            ...
            kits.map(function (kit) {
                ...
                return [
                    ...
                    canInstallSubscribe
                        ...
                        : (
                            '<a class="button wkit-button-tertiary" href="https://wiratheme.com/wirakit/wira-extended/" target="_blank" rel="noopener noreferrer"><span class="dashicons dashicons-awards margin-right-7"></span>Get All Access</a>'
                        ),
                    '</div>',
                    '</div>',
                    '</div>'
