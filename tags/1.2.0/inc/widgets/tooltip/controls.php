...
$this->add_control(
	...
	array(
		...
		'type'      => \Elementor\Controls_Manager::COLOR,
		'selectors' => array(
			'{{WRAPPER}} .wkit-tooltip-icon svg' => 'fill: {{VALUE}};',
		),
	)
);
...
$this->add_control(
    ...
    [
        ...
        'type'      => \Elementor\Controls_Manager::COLOR,
        'selectors' => [
            '{{WRAPPER}} .tooltip-glow::before, {{WRAPPER}} .tooltip-glow::after, {{WRAPPER}} .tooltip-glow i::after' => 'color: {{VALUE}};',
        ],
        'condition' => [
            'enable_tooltip_glow' => 'yes',
        ],
    ]
);
...
$this->add_responsive_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .tooltip-glow::before, {{WRAPPER}} .tooltip-glow::after, {{WRAPPER}} .tooltip-glow i::after' => '--glow-size: {{SIZE}}{{UNIT}};',
        ],
        'default' => [
            'size' => 15,
            'unit' => 'px',
...
$this->add_responsive_control(
    ...
    [
        ...
        'size_units' => [ 'px', 'em', '%' ],
        'selectors' => [
            '{{WRAPPER}} .tooltip-glow::before, {{WRAPPER}} .tooltip-glow::after, {{WRAPPER}} .tooltip-glow i::after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        'condition' => [
            'enable_tooltip_glow' => 'yes',
        ],
...
$this->add_control(
	...
	array(
		...
		'type'      => \Elementor\Controls_Manager::COLOR,
		'selectors' => array(
			'{{WRAPPER}} .wkit-tooltip-wrapper:hover .wkit-tooltip-icon svg' => 'fill: {{VALUE}};',
		),
	)
);
