...
$this->add_responsive_control(
    'service_box_wrapper_margin',
    [
        'label'      => __( 'TranslateY', 'wira-kit-for-elementor' ),
        'type' => \Elementor\Controls_Manager::SLIDER,
        'default' => [
            'size' => 0,
        ],
        ...
        'selectors'  => [
            '{{WRAPPER}} .wkit-info-box-repeater-content-wrapper' => 'transform: translateY({{SIZE}}{{UNIT}});',
        ],
    ]
);

$this->add_control(
	'service_box_wrapper_opacity',
	array(
		...
		'selectors' => array(
			'{{WRAPPER}} .wkit-info-box-repeater-content-wrapper' => 'opacity: {{SIZE}};',
		),
	)
);
...
$this->add_responsive_control(
    'service_box_wrapper_margin_hover',
    [
        'label'      => __( 'TranslateY', 'wira-kit-for-elementor' ),
        'type' => \Elementor\Controls_Manager::SLIDER,
        'default' => [
        ...
        'selectors'  => [
            '{{WRAPPER}} .wkit-info-box-repeater-item-wrapper:hover .wkit-info-box-repeater-content-wrapper' => 'transform: translateY({{SIZE}}{{UNIT}});',
        ],
    ]
);

$this->add_control(
	'service_box_wrapper_opacity_hover',
	array(
		'label' => __( 'Opacity', 'wira-kit-for-elementor' ),
		'type'  => \Elementor\Controls_Manager::SLIDER,
		'range' => array(
		...
		'selectors' => array(
			'{{WRAPPER}} .wkit-info-box-repeater-item-wrapper:hover .wkit-info-box-repeater-content-wrapper' => 'opacity: {{SIZE}};',
		),
	)
);
